...
Each exam is labeled (Test 1 through Test 11). Each page is stamped with the source exam, module, and original page number.
...
```bash
python3 sat-prep/official-math/extract_math_pages.py
```
