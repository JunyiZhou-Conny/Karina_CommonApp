...
- If they hide the exponent and give you the percent and the months: convert months → years, then \(k=1/(\text{years per cycle})\).
...
### Rational \(f(x)=\dfrac{a}{x+b}\), then a shift
...
**5.** The rational function \(f\) is defined by \(f(x)=\dfrac{a}{x+b}\), where \(a\) and \(b\) are constants. The graph of \(y=f(x)\) has a vertical asymptote at \(x=-2\) and passes through \((0,3)\). If \(g(x)=f(x-3)\), which equation could define \(g\)?
...
**8.** The rational function \(h\) is defined by \(h(x)=\dfrac{a}{x+b}\). The graph of \(y=h(x)\) has a vertical asymptote at \(x=5\) and passes through \((7,4)\). If \(p(x)=h(x+2)\), which equation could define \(p\)?
