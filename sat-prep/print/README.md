...
**Print the current homework (10 items):** [`TARGETED-SET-04.pdf`](TARGETED-SET-04.pdf) — notes + questions for Karina; **no key in this file.**  
...
timeout 45 google-chrome --headless --disable-gpu --no-sandbox --no-pdf-header-footer \
  ...
  --print-to-pdf=sat-prep/print/TARGETED-SET-04.pdf \
  file://$PWD/sat-prep/print/TARGETED-SET-04.html
```
