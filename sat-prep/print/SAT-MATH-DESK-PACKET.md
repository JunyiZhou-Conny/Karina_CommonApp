...
**Student:** Karina  
**Goal:** Digital SAT Math about 680 → about 780  
...
| **D Geometry & Trig** | ~15% | 5–7 | Area and volume, similar triangles, Pythagorean, special rights, \(\sin\cos\tan\), circles |
...
- Ratio \(a:b\) with first part \(A\): \(\dfrac{a}{b}=\dfrac{A}{B}\).
...
- Linear scale \(k\) \(\Rightarrow\) area \(\times k^2\), volume \(\times k^3\).
...
A) \(-\dfrac{5}{2}\) B) \(-\dfrac{2}{5}\) C) \(\dfrac{2}{5}\) D) \(\dfrac{5}{2}\)
...
**A9.** Which point \((x,y)\) is a solution to both \(y\le -x+2\) and \(y\ge 0\)?  
A) \((3,0)\) B) \((0,3)\) C) \((1,0.5)\) D) \((-1,4)\)

**A10.** A line in the \(xy\)-plane passes through \((2,5)\) and \((6,13)\). Which equation represents the line?  
A) \(y=2x+1\) B) \(y=2x-1\) C) \(y=\dfrac{1}{2}x+4\) D) \(y=8x-11\)

**A11.** Which equation represents the line that is perpendicular to \(y=3x-1\) and passes through \((0,4)\)?  
A) \(y=3x+4\) B) \(y=-\dfrac{1}{3}x+4\) C) \(y=\dfrac{1}{3}x+4\) D) \(y=-3x+4\)

**A12.** (SPR) \( \dfrac{5x-2}{4}=\dfrac{x+6}{2} \). What is the value of \(x\)?
...
A) \(x=\dfrac{1}{4}\) B) \(x=0\) C) \(x=1\) D) \(x=2\)
...
**B2.** Which expression is equivalent to \(\dfrac{x^2-9}{x-3}\) for \(x\neq 3\)?  
A) \(x-3\) B) \(x+3\) C) \(x^2-3\) D) \(9-x\)

**B3.** (SPR) \((3x^2 y)^2=ax^b y^c\), where \(a\), \(b\), and \(c\) are positive. What is the value of \(a+b+c\)?
...
A) \(3\) and \(-3\) B) \(3\) and \(-\dfrac{11}{3}\) C) \(\dfrac{11}{3}\) and \(-3\) D) \(3\) only

**B10.** How many distinct real solutions does \(|x-2|=-5\) have?  
A) Zero B) One C) Two D) Infinitely many

**B11.** (SPR) What is the solution of \(\dfrac{x+3}{x-1}=2\)?
...
A) \(\dfrac{18}{50}\) B) \(\dfrac{18}{30}\) C) \(\dfrac{30}{50}\) D) \(\dfrac{18}{20}\)
...
A) \(\dfrac{18}{30}\) B) \(\dfrac{18}{50}\) C) \(\dfrac{30}{50}\) D) \(\dfrac{18}{20}\)

---

## 6. Geometry and trigonometry questions

**D1.** (SPR) What is the volume of a cube with edge length 3?

**D2.** Every edge of a cube is multiplied by \(\dfrac{1}{2}\). The new volume is what fraction of the original volume?  
...
**D4.** A triangle has angles measuring \(40^\circ\) and \(65^\circ\). What is the measure of the third angle?  
A) \(65^\circ\) B) \(75^\circ\) C) \(85^\circ\) D) \(95^\circ\)

**D5.** Two figures are similar with scale factor 3. A \(5^\circ\) angle in the smaller figure corresponds to an angle of what measure in the larger figure?  
A) \(15^\circ\) B) \(5^\circ\) C) \(45^\circ\) D) \(3^\circ\)
...
**D9.** In a right triangle, the side opposite \(\theta\) has length 3 and the hypotenuse has length 5. What is \(\sin\theta\)?  
A) \(\dfrac{3}{4}\) B) \(\dfrac{3}{5}\) C) \(\dfrac{4}{5}\) D) \(\dfrac{4}{3}\)
...
**D12.** A circle has radius 6. What is the length of an arc with central angle \(60^\circ\)?  
A) \(\pi\) B) \(2\pi\) C) \(6\pi\) D) \(12\pi\)
...
**M2.** Which equation represents a line with slope \(-\dfrac{1}{2}\) that passes through \((0,6)\)?  
A) \(y=2x+6\) B) \(y=-\dfrac{1}{2}x+6\) C) \(y=-\dfrac{1}{2}x-6\) D) \(y=\dfrac{1}{2}x+6\)
...
**M12.** How many distinct real solutions does \(\dfrac{x}{x-1}=\dfrac{2}{x-1}+1\) have?  
A) Zero B) One C) Two D) Infinitely many
...
**M21.** A circle has radius 8 and a central angle of \(90^\circ\). What is the arc length?  
...
**A1.** \(f(2)=9\), \(g(2)=14\), \(4\cdot9-14=22\). **C**  
**A2.** \(2y=-5x+10\), \(y=-\dfrac{5}{2}x+5\). **A**  
...
**A10.** \(m=\dfrac{8}{4}=2\), \(y-5=2(x-2)\), \(y=2x+1\). **A**  
**A11.** Perpendicular slope \(-\dfrac{1}{3}\), through \((0,4)\). **B**  
**A12.** \(2(5x-2)=4(x+6)\) \(\Rightarrow\) \(x=\dfrac{14}{3}\)  
**A13.** \(120-4t=0\) \(\Rightarrow\) \(t=30\)  
**A14.** \(6+k>10\) \(\Rightarrow\) \(k>4\). **A**  
**A15.** \(7-6x+3=2x+8\) \(\Rightarrow\) \(x=\dfrac{1}{4}\). **A**  
**A16.** \(0.10t=12\) \(\Rightarrow\) \(t=120\)

### Advanced Math

**B1.** Factor \(x+4\): \((x+4)(2x-1)\). **A**  
**B2.** \(\dfrac{(x-3)(x+3)}{x-3}=x+3\). **B**  
**B3.** \(9x^4 y^2\) \(\Rightarrow\) \(9+4+2=15\)  
**B4.** Difference of cubes. **B**  
**B5.** \(x=3\) or \(x=-1\). **A**  
**B6.** \(g(x)=(x-0)^2+55\). Minimum **55**. **C**  
**B7.** \(x=-\dfrac{b}{2a}=4\)  
**B8.** \(9\)  
**B9.** \(x=3\) or \(x=-\dfrac{11}{3}\). **B**  
...
**D1.** \(27\)  
**D2.** \(\left(\dfrac{1}{2}\right)^3=\dfrac{1}{8}\). **C**  
**D3.** Area ratio \(4:9\), \(20\times\dfrac{9}{4}=45\). **C**  
**D4.** \(75^\circ\). **B**  
...
**D11.** \(10\)  
**D12.** \(\dfrac{1}{6}\cdot 12\pi=2\pi\). **B**  
**D13.** \(r=4\). **B**  
**D14.** \(\dfrac{10}{5}=\dfrac{h}{2}\) \(\Rightarrow\) \(h=4\). **B**  
**D15.** \(10\). **B**
...
**M16.** **C**  
**M17.** \(600/95=\dfrac{120}{19}\) (about \(6.32\))  
**M18.** \(6x=180\) \(\Rightarrow\) \(x=30\). **B**  
**M19.** \(12\)  
**M20.** 9-12-15. **B**  
**M21.** \(\dfrac{1}{4}\cdot 16\pi=4\pi\). **B**  
**M22.** Center \((-3,1)\). **B**
