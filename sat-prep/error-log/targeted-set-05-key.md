...
| 7 | **\(\dfrac{14}{23}\)** | K28 | Interpret, then \(P(A\mid B)\) | \(A\): the tree is a spruce. \(B\): the tree is tagged. \(A\mid B\): spruce, given tagged. \(A\cap B\): spruce **and** tagged. Formula \(P(A\cap B)/P(B)=(14/50)/(23/50)=14/23\). Trap \(14/50\) (joint, not conditional), \(14/20\) (row). |
...
- \(A\): the selected tree is a spruce.
- \(B\): the selected tree is tagged.
...
**Interpretations they must write on #8**

- \(A\): the selected member is a senior.
- \(B\): the selected member is enrolled in calculus.
- \(A\mid B\): the selected member is a senior, given that the member is enrolled in calculus. (Only the Calculus column.)
- \(A\cap B\): the selected member is a senior **and** enrolled in calculus.
- Formula: \(P(A\mid B)=P(A\cap B)/P(B)\).
...
If she misses **7 / 8** with a denominator of \(50\) or \(60\), she computed \(P(A\cap B)\) and never conditioned.  
